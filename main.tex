...
{\customcventry{Apr 2020}{4 Course Specialization by deeplearning.ai}{TensorFlow: Data and Deployment}{}{}{TensorFlow.js, TensorFlow Lite, Data Pipelines, Deploying Models}}
\vspace{1mm}

{\customcventry{Mar 2020}{4 Course Specialization by deeplearning.ai}{TensorFlow Developer}{}{}{CNN's, NLP, Time Series}}
\vspace{1mm}

{\customcventry{Dec 2019 - Dec 2022}{Certificate by Amazon Web Services}{AWS Certified Solutions Architect Associate}{}{}{}}
\vspace{-1mm}
...
{\begin{itemize}
  \item Enhance student learning experience by implementing technology in the classroom.
\vspace*{2pt}
  \item Makes educational decisions based on student data.
  \vspace*{2pt}
  \item Effectively communicates with parents and guardians to support student success.
\end{itemize}
}
\vspace*{5pt}
...
{\customcventry{Apr 2016 - Jun 2017}{Product Analyst}{Homesite Insurance}{Boston, MA}{}
{\begin{itemize}
\vspace*{2pt}
  \item Provided analysis and data validation using SAS.
  \vspace*{2pt}
  \item Queried databases using SQL.
  \vspace*{2pt}
  \item Automated department processes with VBA code for Microsoft Excel and PowerPoint.
\end{itemize}
}
}
